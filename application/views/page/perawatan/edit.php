				...
				<div class="card-body">
					<form action="" method="post" autocomplete="off">
						<div class="form-group">
							...
							<input type="text" name="nama" id="nama" class="form-control" placeholder="Nama" aria-describedby="nama" value="<?= $perawatan->nama; ?>">
						...
						<div class="form-group">
							...
							<select name="jenis" id="jenis" class="form-select">
								<?php foreach ($jenis as $j) : ?>
									<option <?= $j->id == $perawatan->jenis_id ? 'selected' : null; ?> value="<?= $j->id; ?>"><?= $j->nama; ?></option>
								<?php endforeach; ?>
							</select>
						...
						<div class="form-group">
							...
							<select name="tanaman" id="tanaman" class="form-select">
								...
								<?php foreach ($tanaman as $t) : ?>
									<option <?= $t->id == $perawatan->tanam_id ? 'selected' : null; ?> value="<?= $t->id; ?>"><?= $t->nama; ?></option>
								<?php endforeach; ?>
							</select>
