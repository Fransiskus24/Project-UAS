				...
				<div class="card-body">
					<form action="" method="post" autocomplete="off">
						<div class="form-group">
							...
							<input type="date" name="tanggal" id="tanggal" class="form-control" placeholder="Tanggal" aria-describedby="tanggal">
						...
						<div class="form-group">
							...
							<input type="text" name="variates" id="variates" class="form-control" placeholder="Variates" aria-describedby="variates">
							<small id="password" class="text-danger"><?= form_error('variates'); ?></small>
						</div>
						<div class="form-group">
							<label for="lokasi">Lokasi</label>
							<input type="text" name="lokasi" id="lokasi" class="form-control" placeholder="Lokasi" aria-describedby="lokasi">
